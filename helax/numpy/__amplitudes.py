...
# from helax.vertices import  VertexWWS, VertexWWV


# from .wavefunctions import WeylType, WeylWf
...
#     return attach_vector(
#         VectorWf(wavefunction=wavefunction, momentum=momentum, direction=1),
#                               mass, width
#     )
...
#     return attach_weyl(
#         WeylWf(wavefunction=wavefunction, momentum=momentum, type=chi.type),
#                   mass, width
#     )
...
#         ScalarWf(wavefunction=wavefunction, momentum=momentum, direction=1),
#                       mass, width
#     )
